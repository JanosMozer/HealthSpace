...
import { Patient, BodyPart, Examination } from '@/types/patient';
...
const ImagingResultsTab = ({ patient, isDoctor, onAddExamination, setPatient }: ImagingResultsTabProps) => {
  ...
  const handleExaminationSubmit = async (data: any) => {
    ...
    try {
        ...
        setPatient(prev => ({
          ...
          examinations: [
            ...(prev.examinations || []),
            {
              ...
              bodyPart: data.bodyPart as BodyPart || undefined,
      ...
      setIsFormOpen(false);
      toast({
        title: "Imaging result added",
        description: "The imaging result has been saved successfully.",
      });
      ...
      toast({
        title: "Error",
        description: "Failed to add imaging result.",
        variant: "destructive"
      });
    }
  };
  ...
  return (
    <TabsContent value="examinations">
      <div className="flex justify-between items-center mb-4">
        <h3 className="text-xl font-bold">Imaging Results</h3>
      </div>
      ...
      {isDoctor && (
        ...
        >
          <CollapsibleTrigger asChild>
            ...
            >
              <span>Add New Imaging Result</span>
              ...
              <form onSubmit={examinationForm.handleSubmit(handleExaminationSubmit)} className="space-y-4 p-4 border border-border rounded-md">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        <FormLabel>Imaging Name</FormLabel>
                        <FormControl>
                          <Input placeholder="Imaging name..." {...field} />
                        </FormControl>
                      </FormItem>
                    )}
                  />
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Related Body Part</FormLabel>
                      <Select
                        value={field.value}
                ...
                */}
                ...
                <div className="flex justify-end">
                  <Button type="submit">Save Imaging Result</Button>
                </div>
              </form>
            </Form>
          </CollapsibleContent>
            ...
            >
              <div className="flex justify-between items-center mb-2">
                <div>
                  ...
                  {exam.bodyPart && (
                    <p className="text-xs text-muted-foreground">
                      Body Part: {bodyPartOptions.find(bp => bp.value === exam.bodyPart)?.label || 
                        exam.bodyPart.replace(/([A-Z])/g, ' $1').trim()}
                    </p>
                  )}
                </div>
